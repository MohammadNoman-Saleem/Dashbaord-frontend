...
// Projects tasks for the p-my-tasks home panel, split into two groups for the
// panel's tabs: "mine" is their work outside Cross-Department (across any
// project), "cross" is their Cross-Department tasks. Reads only; changes go
// through the board or the assistant. Rows carry the task and project ids so a
// row can deep link to the board and open the task detail. Serves dev smoke
// until the live route is up; the real list is resolved from the session.
...
// on the right board tab in dev smoke; a third stands in for an "Other" project.
const IT_PROJECT = '2599674000000342004'
const CROSS_PROJECT = '2599674000000344008'
const MARKETING_PROJECT = 'proj-fx-marketing'
  ...
  mine: {
    rows: [
      ...
      },
      {
        ...
        tab: 'other',
        title: 'June campaign creative review',
        due_display: 'Jun 20',
        due_state: 'upcoming',
        overdue_days: 0,
        priority: 'Medium',
